...
function isValidFilmObject(filmObject) {
  return (
    filmObject.filmTitle !== undefined &&
    typeof filmObject.filmTitle === 'string' &&
    filmObject.releaseYearString !== undefined &&
    typeof filmObject.releaseYearString === 'string' &&
    filmObject.directorNameArray !== undefined &&
    Array.isArray(filmObject.directorNameArray) &&
    // @ts-ignore
    filmObject.directorNameArray.every((element) => typeof element === 'string') &&
    filmObject.averageRatingString !== undefined &&
    typeof filmObject.averageRatingString === 'string' &&
    filmObject.filmPosterURL !== undefined &&
    typeof filmObject.filmPosterURL === 'string' &&
    filmObject.filmBackdropImageURL !== undefined &&
    typeof filmObject.filmBackdropImageURL === 'string'
  );
}
